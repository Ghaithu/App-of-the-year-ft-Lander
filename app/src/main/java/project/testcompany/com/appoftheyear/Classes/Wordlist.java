...
public class Wordlist {
    ...
    public String[] csgo = {"Dust2", "Nuke", "Overpass", "Cache", "UMP", "AWP", "Bomb"};
    public String[] runescapeDisc = {"A friend","Town on the edge", "8 legs", "breaths fire","place where death takes you", "the place delrith lurks","noobs kill this"};
    ...
    public String[] csgoDisc = {"Best map", "Boom", "Germany", "slav", "best SMG", "sniper", "plant it"};
